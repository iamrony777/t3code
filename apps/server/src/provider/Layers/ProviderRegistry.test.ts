          ...
          Effect.gen(function* () {
            ...
            const instanceRegistryLayer = Layer.succeed(
              ProviderInstanceRegistry.ProviderInstanceRegistry,
              {
                ...
                useInstance: (id, use) => use(id === instance.instanceId ? instance : undefined),
        ...
        Effect.gen(function* () {
          ...
          const instanceRegistryLayer = Layer.succeed(
            ProviderInstanceRegistry.ProviderInstanceRegistry,
            {
              ...
              useInstance: (requestedId, use) =>
                Ref.get(instancesRef).pipe(
                  Effect.flatMap((instances) =>
                    use(instances.find((instance) => instance.instanceId === requestedId)),
                  ),
                ),
