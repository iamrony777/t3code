...
import { PROVIDER_ORDER, PROVIDER_PRESENTATION, visibleProviders } from "./usageProviders";
...
export function UsagePage() {
  ...
  // Chart bands, legend and period columns all follow the data, so a provider
  // the user never runs does not hold a permanently-zero slot across the page.
